export const SITE = {
  name: process.env.NEXT_PUBLIC_SITE_NAME || "NexGuard Technologies",
  shortName: "NexGuard Tech",
  phone: process.env.NEXT_PUBLIC_PHONE || "+254794273995",
  phoneDisplay: process.env.NEXT_PUBLIC_PHONE_DISPLAY || "+254 794 273 995",
  email: process.env.NEXT_PUBLIC_EMAIL || "nexguard100@gmail.com",
  whatsapp: process.env.NEXT_PUBLIC_WHATSAPP || "+254794273995",
